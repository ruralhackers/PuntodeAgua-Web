...
const Navigation: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-500 px-6 lg:px-8">
      <div className={`max-w-5xl mx-auto mt-4 transition-all duration-500 ${
        isScrolled 
          ? 'bg-white/90 backdrop-blur-xl shadow-2xl border border-white/50' 
          : 'bg-white/60 backdrop-blur-lg shadow-lg border border-white/30'
      } rounded-2xl`}>
        <div className="flex justify-between items-center h-16 px-6">
          ...
          <div className="hidden lg:flex items-center space-x-2">
            ...
            <Link 
              to="/activa-tu-pueblo" 
              className={`text-sm font-medium transition-all duration-300 px-4 py-2 rounded-xl group ml-2 ${
            ...
            <button className="bg-white/80 text-gray-900 px-4 py-2 rounded-xl text-sm font-semibold hover:bg-white transition-all duration-300 ml-3 border border-gray-200/50 hover:shadow-md">
              Iniciar sesión
            </button>
          </div>
          ...
          <div className="lg:hidden">
            <button 
              ...
              className="p-2 rounded-xl transition-all duration-300 text-gray-700 hover:bg-white/50"
            >
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden">
            <div className="px-6 py-6 space-y-3 border-t border-white/30">
              <Link 
                to="/" 
